    ...
    <main className="container-fluid">
        <div className="main-content mx-auto my-3 register-container px-2 pt-2 pb-4">
            <form className='form' onSubmit={submitHandler}>
                <div className="register-header text-capitalize p-2">Create Account</div>
                {loading && <Preloader class='menu-preloader'></Preloader>}
                {error && <MessageBox>{error}</MessageBox>}
                <section className="register-name-container my-sm-2 p-2">
                ...
                <section className="register-email-container my-2 p-2">
                ...
                <section className="register-password-container my-2 p-2">
                ...
                <section className="register-confirm-password-container my-2 p-2">
                ...
                <footer className="d-flex justify-content-center align-items-center mt-4 flex-column">
                    <button type="submit" className="btn btn-primary register-submit text-capitalize">sign-up</button>
